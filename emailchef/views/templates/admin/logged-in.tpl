<div class="ecps-main-container">
    <div class="ecps-main-account">
        ...
        <!--<div>
            ...
            <div class="ecps-list-container <?php echo $list_id != null ? "ecps-has-list" : ""; ?>" id="listName">
            <span>
            ...
            <span class="truncate ecps-list-selected" title="<?php echo $list_name; ?>" id="ecps-list-selected">
                    <?php echo $list_name; ?>
                </span>
        </div>-->
    </div>
