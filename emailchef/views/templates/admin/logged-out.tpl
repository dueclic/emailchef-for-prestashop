<div class="ecps-not-logged-container">
    ...
    <div class="ecps-not-logged" id="ecps-not-logged">
        ...
        <div class="ecps-text-center">
            <img class="ecps-login-logo" src="{$module_dir}views/img/emailchef.png"
                 alt="{l s='Emailchef' mod='emailchef'}"/>
        </div>

        <p class="ecps-text-center ecps-not-logged-signup">
            {l s="Not a member?" mod="emailchef"} <a target="_blank"
                                                     href="https://app.emailchef.com/apps/demo/quicksignup">
                {l s="Sign up for free" mod="emailchef"}
            </a>.
        </p>
        ...
        <form method="post" action="">
            ...
            <fieldset>
                ...
                <div class="ecps-not-logged-control-group">
                ...
                <div class="ecps-not-logged-control-group ecps-not-logged-password-field">

                    <label for="consumer_secret">{l s="Consumer Secret:" mod="emailchef"}</label>
                    <input class="ecps-input" type="password" id="consumer_secret" value="" name="consumer_secret">

                    <a id="showPassword" title="{l s="Show Consumer Secret" mod="emailchef"}">
                    ...
                    <a id="hidePassword" style="display: none" title="{l s="Hide Consumer Secret" mod="emailchef"}">
